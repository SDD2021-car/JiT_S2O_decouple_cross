...
def get_args_parser():
    ...
    # checkpointing
    parser.add_argument('--output_dir', default='/NAS_data/hjf/JiTcolor/checkpoints/SAR2Opt/caJiT_CP/round4/noLoss_noHintsDropout_dot_concat_sam2_bs8_decouple_CA',
                        help='Directory to save outputs (empty for no saving)')
    parser.add_argument('--resume', default="/NAS_data/hjf/JiTcolor/checkpoints/SAR2Opt/caJiT_CP/round4/noLoss_noHintsDropout_dot_concat_sam2_b8_decouple_CA",
